...
async def test_tweet_feed(
    client: AsyncClient, test_session: AsyncSession, add_user, test_tweet_with_media, second_user, create_like
):
    ...
    answer = {"result": True, "tweets": [
                                        {
                                            ...
                                            "attachments": [media.path for media in test_tweet_with_media.tweet_media_ids],
